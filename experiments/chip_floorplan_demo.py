...
def main() -> None:
    ...
    print("profile: retire128c2 compressed counting-sidecar CSA/HCA-aware context summaries")
    ...
    print("- retire128c2 adds the compressed online counting Bloom sidecar on top of joint probe/fanout control.")
