...
def main() -> None:
    ...
    print("profile: retire128 counting-sidecar CSA/HCA-aware context summaries")
    ...
    print("- retire128 adds the online counting Bloom sidecar on top of joint probe/fanout control.")
