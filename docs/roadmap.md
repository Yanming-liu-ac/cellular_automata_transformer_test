...
slightly lowers touch/event.

The first compression version is now implemented. `factor_vote56b` and
`factor_vote80b` replace the monolithic 7D guard with projected one-bit vote
